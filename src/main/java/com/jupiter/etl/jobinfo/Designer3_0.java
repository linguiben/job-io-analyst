 ...
 * @author  __USER__
 */
public class Designer3_0 extends javax.swing.JFrame implements ActionListener {
	...
	User user = null;
	DesignerGraph graph = new DesignerGraph(user);

	public Designer3_0(User user) {
		this.user = user;
		// 设置图形界面外观
		try {
	...
	public static void main(String args[]) {
		Designer3_0 ds = new Designer3_0();
	...
	//测试
	public void sampleAnalyze() {
		ArrayList<Job> c1 = new ArrayList<Job>();
